...
sbatch  --export=ALL,ALG='cleanrl/dqn_atari.py',ENV_ID='SpaceInvadersNoFrameskip-v4' launchGPU.sh
sbatch  --export=ALL,ALG='cleanrl/dqn_atari.py',ENV_ID='AsterixNoFrameskip-v4' launchGPU.sh
sbatch  --export=ALL,ALG='cleanrl/dqn_atari.py',ENV_ID='MontezumaRevengeNoFrameskip-v4' launchGPU.sh
# sbatch  --export=ALL,ALG='cleanrl/dqn_atari.py',ENV_ID='SpaceInvadersNoFrameskip-v4',INTRINSIC_REWARDS='--intrinsic_rewards' launchGPU.sh
# sbatch  --export=ALL,ALG='cleanrl/dqn_atari.py',ENV_ID='AsterixNoFrameskip-v4',INTRINSIC_REWARDS='--intrinsic_rewards' launchGPU.sh
# sbatch  --export=ALL,ALG='cleanrl/dqn_atari.py',ENV_ID='MontezumaRevengeNoFrameskip-v4',INTRINSIC_REWARDS='--intrinsic_rewards' launchGPU.sh

sbatch  --export=ALL,ALG='cleanrl/ppo_atari.py',ENV_ID='SpaceInvadersNoFrameskip-v4' launchGPU.sh
sbatch  --export=ALL,ALG='cleanrl/ppo_atari.py',ENV_ID='AsterixNoFrameskip-v4' launchGPU.sh
sbatch  --export=ALL,ALG='cleanrl/ppo_atari.py',ENV_ID='MontezumaRevengeNoFrameskip-v4' launchGPU.sh
# sbatch  --export=ALL,ALG='cleanrl/ppo_atari.py',ENV_ID='SpaceInvadersNoFrameskip-v4',INTRINSIC_REWARDS='--intrinsic_rewards' launchGPU.sh
# sbatch  --export=ALL,ALG='cleanrl/ppo_atari.py',ENV_ID='AsterixNoFrameskip-v4',INTRINSIC_REWARDS='--intrinsic_rewards' launchGPU.sh
# sbatch  --export=ALL,ALG='cleanrl/ppo_atari.py',ENV_ID='MontezumaRevengeNoFrameskip-v4',INTRINSIC_REWARDS='--intrinsic_rewards' launchGPU.sh
