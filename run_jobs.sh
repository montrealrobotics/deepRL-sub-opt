...
sbatch --export=ALL,ALG='cleanrl/dqn_atari.py',ENV_ID='MontezumaRevengeNoFrameskip-v4',ARGSS='--start_e=0.5 --network_type ResNet --total_timesteps 10000000' launchGPU.sh
